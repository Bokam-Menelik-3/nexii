...
class FirebaseService {
  ...
  Future<void> _restoreSession() async {
    try {
      ...
      final isLoggedInStr = prefs.getString('nexii_is_logged_in');
      if (isLoggedInStr == 'true') {
        _uid = prefs.getString('nexii_user_uid');
        _email = prefs.getString('nexii_user_email');
        _idToken = prefs.getString('nexii_user_idToken');
        _isLoggedIn = true;
      }
    } catch (e) {
  ...
  Future<void> _clearSession() async {
    try {
      final prefs = await SharedPreferences.getInstance();
      await prefs.remove('nexii_is_logged_in');
      await prefs.remove('nexii_user_uid');
      await prefs.remove('nexii_user_email');
      await prefs.remove('nexii_user_idToken');
    } catch (e) {
...
class AppHelpers {
  ...
  {
    path: "lib/intelligence/context/context_snapshot_builder.dart",
    name: "context_snapshot_builder.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
...
`
  ...
  {
    path: "lib/intelligence/engines/n1_decision_engine.dart",
    name: "n1_decision_engine.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
...
`
  ...
  {
    path: "lib/intelligence/models/intelligence_models.dart",
    name: "intelligence_models.dart",
    category: "Config",
    code: `class TaskSummary {
  const TaskSummary({
    required this.id,
    required this.title,
...
`
  ...
  {
    path: "lib/intelligence/nodes/anticipate_node.dart",
    name: "anticipate_node.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
...
`
  ...
  {
    path: "lib/intelligence/nodes/aura_node.dart",
    name: "aura_node.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
import 'intelligence_node.dart';
...
`
  ...
  {
    path: "lib/intelligence/nodes/intelligence_node.dart",
    name: "intelligence_node.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
...
`
  ...
  {
    path: "lib/intelligence/nodes/living_goals_node.dart",
    name: "living_goals_node.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
import 'intelligence_node.dart';
...
`
  ...
  {
    path: "lib/intelligence/nodes/measure_node.dart",
    name: "measure_node.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
import 'intelligence_node.dart';
...
`
  ...
  {
    path: "lib/intelligence/nodes/observe_node.dart",
    name: "observe_node.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
import 'intelligence_node.dart';
...
`
  ...
  {
    path: "lib/intelligence/nodes/pulse_node.dart",
    name: "pulse_node.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
import 'intelligence_node.dart';
...
`
  ...
  {
    path: "lib/intelligence/nodes/recommend_node.dart",
    name: "recommend_node.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
import 'intelligence_node.dart';
...
`
  ...
  {
    path: "lib/intelligence/nodes/understand_node.dart",
    name: "understand_node.dart",
    category: "Config",
    code: `import '../models/intelligence_models.dart';
import 'intelligence_node.dart';
...
`
  ...
  {
    path: "lib/intelligence/services/intelligence_service.dart",
    name: "intelligence_service.dart",
    category: "Config",
    code: `import '../context/context_snapshot_builder.dart';
    ...
    return Container(
      ...
      child: ListTile(
        leading: Container(
          padding: const EdgeInsets.all(8),
          decoration: BoxDecoration(
            color: isNegative ? const Color(0xffef4444).withValues(alpha: 0.1) : const Color(0xff22c55e).withValues(alpha: 0.1),
            shape: BoxShape.circle,
          ),
          child: Icon(
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: const Color(0xff8b5cf6).withValues(
                                  alpha: 0.1 * _breathAnimation!.value),
                              border: Border.all(
                                color: const Color(0xff8b5cf6).withValues(
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            _isRunning ? Colors.amber : const Color(0xff2563eb),
                        foregroundColor: Colors.white,
                        padding: const EdgeInsets.symmetric(
                      ...
                      onPressed:
                          _isRunning ? _pauseTimer : () => _startTimer(state),
                      child: Text(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: '••••••••',
                      prefixIcon: Icon(Icons.lock_outline, color: primaryColor.withValues(alpha: 0.7)),
                      filled: true,
                      fillColor: isDark ? const Color(0xff1e293b) : Colors.white,
                      border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(14),
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor: AlwaysStoppedAnimation<Color>(
                      isUnlocked ? gradient.first : gradient.first.withValues(alpha: 0.7),
                    ),
                  ),
                ),
              ],
            ...
            Expanded(
              child: Align(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isToday ? const Color(0xff8b5cf6) : const Color(0xff8b5cf6).withValues(alpha: 0.2),
